...
function pyplot_hexagonal(ax::PyCall.PyObject, cax::PyCall.PyObject, input::Dict, data::Matrix{T};
    ...
    PyPlot.colorbar(im, label=colorbar_title, cax=cax)
...
pyplot_hexagonal(ax1, cax1, Data, abs.(curvature), cmap = "Greys")
pyplot_hexagonal(ax2,cax2, Data, metric_sqrtDets, cmap = "Greys")
pyplot_hexagonal(ax3,cax1, Data_2, abs.(curvature_2), cmap = "Greys")
pyplot_hexagonal(ax4,cax2, Data_2, metric_sqrtDets_2, cmap = "Greys")
