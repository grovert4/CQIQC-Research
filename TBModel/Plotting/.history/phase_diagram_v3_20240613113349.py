...
plt.colorbar(im, ax=ax, label=r'$N(k)_{max}$',rasterized=True)
...
plt.colorbar(im_ins, cax=cax, label=r'$\sigma_{xy}$', rasterized=True)

plt.savefig("Plots/"+filename+"_U_V.pdf",dpi=240,bbox_inches = 'tight' format = 'pdf')
