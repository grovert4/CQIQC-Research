...
pyplot_hexagonal(ax2,cax2, Data, metric_sqrtDets, cmap = "bone_r")
pyplot_hexagonal(ax3,cax1, Data_2, abs.(curvature_2), cmap = "Purples")
pyplot_hexagonal(ax4,cax2, Data_2, metric_sqrtDets_2, cmap = "bone_r", colorbar_title=L"V_n(\mathbf{k})")
