...
a1 = [ 1/2 , sqrt(3)/2 ]
a2 = [-1/2 , sqrt(3)/2 ]
UC = UnitCell( [a1 , a2] , 2, 2) ##### localDim = 2 cause we are Constructing a spinful version of the Haldane Model. rank = 2 cause we are ructing a free Hamiltonian.
