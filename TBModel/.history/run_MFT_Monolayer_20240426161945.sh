...
mpirun julia --project=.. --heap-size-hint=1G MFT_wrapper_v2.jl 04.25.2024_Monolayer_NN ./Monolayer_MFT.jl
...
mpirun julia --project=.. --heap-size-hint=1G Extract_LastData.jl "/scratch/a/aparamek/andykh/Data/Monolayer_Data" 04.25
