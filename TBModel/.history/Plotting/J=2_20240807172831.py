...
im = ax.pcolormesh(X, Y, polarization[:Uidx,:Vidx], cmap=new_cmap, vmin=0, vmax=0.521, shading='auto')
...
plt.plot(V_array, ssf[u_idx,:], linewidth = 2, markersize = 10,marker = "X", label = r"$n(Q=K/2)$", color = colors[2])
