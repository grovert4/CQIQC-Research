...
function pyplot_hexagonal(ax::PyCall.PyObject, cax::PyCall.PyObject, input::Dict, data::Matrix{T};
    ...
    annotation::AbstractString="",
    annotation_position::Tuple{Float64, Float64}=(0.0, 1.0),
    clims::Tuple{Float64, Float64}=(0.0, 8.0),
...
fileName = loc * "J=2.0_band=1_metric.jld2"
fileName_2 = loc * "J=2.0_band=13_metric.jld2"
...
ax1.set_title("a)", loc="left", pad = -400, fontsize = 20)
ax2.set_title("b)", loc="left", pad = -400, fontsize = 20)
ax3.set_title("c)", loc="left", pad = -400, fontsize = 20)
ax4.set_title("d)", loc="left", pad = -400, fontsize = 20)
