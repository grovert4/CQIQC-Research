...
ax1.set_title("a)", loc="left", y=0.95, fontsize=20)
ax2.set_title("b)", loc="left", y=0.95, fontsize=20)
ax3.set_title("c)", loc="left", y=0.95, fontsize=20)
ax4.set_title("d)", loc="left", y=0.95, fontsize=20)
