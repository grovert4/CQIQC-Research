...
ax1.set_title("a)", loc="left", pad=-20, fontsize = 20)
ax2.set_title("b)", loc="left", pad=-20, fontsize = 20)
ax3.set_title("c)", loc="left", pad=-20, fontsize = 20)
ax4.set_title("d)", loc="left", pad=-20, fontsize = 20)
