...
plt.plot(U_array, p, linewidth = 2.5, markersize = 7,marker = "X", label = r"$\overline{n}$", color = colors[0])
plt.plot(U_array, ssf[:,0], linewidth = 2.5, markersize = 7,marker = "^", label = r"$n(Q=K/2)$", color = colors[0])
