...
plt.plot(U_array, np.abs(conduct[:,0]), linewidth = 2.5, markersize = 7,marker = "o", label = r"$|\sigma_{xy}|$", color = "")
plt.plot(U_array, p, linewidth = 2.5, markersize = 7,marker = "X", label = r"$\overline{n}$")
plt.plot(U_array, ssf[:,0], linewidth = 2.5, markersize = 7,marker = "^", label = r"$n(Q=K/2)$")
