...
plt.plot(V_array, gap[0,:]/gap[0,-1], linewidth = 2, markersize = 15,marker = "^", label = r"$\Delta$")
plt.plot(V_array, np.abs(conduct[0,:]), linewidth = 2, markersize = 10,marker = "o", label = r"$|\sigma_{xy}|$")
plt.plot(V_array, polarization[0,:]/np.max(polarization[0,:]), linewidth = 2, markersize = 15,marker = "X", label = r"$N(Q)$")
