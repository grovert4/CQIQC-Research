...
plt.plot(U_array, np.abs(conduct[:,0]), linewidth = 2.5, markersize = 5,marker = "o", label = r"$|\sigma_{xy}|$")
plt.plot(U_array, p, linewidth = 2.5, markersize = 5,marker = "X", label = r"$\overline{n}$")
plt.plot(U_array, ssf[:,0], linewidth = 2.5, markersize = 5,marker = "X", label = r"$\overline{n}$")
