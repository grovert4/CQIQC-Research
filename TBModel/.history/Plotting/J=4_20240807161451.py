...
plt.plot(U_array, np.abs(conduct[:,0]), linewidth = 2, markersize = 5,marker = "o", label = r"$|\sigma_{xy}|$")
plt.plot(U_array, p, linewidth = 2, markersize = 10,marker = "X", label = r"$\overline{n}$")
