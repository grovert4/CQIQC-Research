...
plt.plot(V_array, np.abs(conduct[u_idx,:]), linewidth = 2.5, markersize = 8,marker = "o", label = r"$|\sigma_{xy}|$", color = colors[3])
plt.plot(V_array, p, linewidth = 2.5, markersize = 8,marker = "X", label = r"$\Delta \overline{n}$",color = colors[1])
plt.plot(V_array, s, linewidth = 2.5, markersize = 8,marker = "^", label = r"$n(Q=K)$", color = colors[2])
