...
plt.plot(U_array, np.abs(conduct[:Vidx,0]), linewidth = 2.5, markersize = 8,marker = "o", label = r"$|\sigma_{xy}|$", color = colors[3])
plt.plot(U_array, p[:Vidx], linewidth = 2.5, markersize = 8,marker = "X", label = r"$\overline{n}$", color = colors[1])
plt.plot(U_array, ssf[:Vidx,0], linewidth = 2.5, markersize = 8,marker = "^", label = r"$n(Q=K/2)$", color = colors[2])
