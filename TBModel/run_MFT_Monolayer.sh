...
mpirun julia --project=.. --heap-size-hint=1G MFT_wrapper_v2.jl 00.05.2024_Monolayer ./Monolayer_MFT.jl
mpirun julia --project=.. --heap-size-hint=1G Extract_LastData.jl "/scratch/a/aparamek/andykh/Data/Monolayer_Data" 00.05
mpirun julia --project=.. --heap-size-hint=1G MFT_wrapper_v2.jl 01.05.2024_Monolayer ./Monolayer_MFT.jl
mpirun julia --project=.. --heap-size-hint=1G Extract_LastData.jl "/scratch/a/aparamek/andykh/Data/Monolayer_Data" 01.05
mpirun julia --project=.. --heap-size-hint=1G MFT_wrapper_v2.jl 02.05.2024_Monolayer ./Monolayer_MFT.jl
