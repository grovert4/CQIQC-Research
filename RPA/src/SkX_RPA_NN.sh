...
julia --project=../../TBModel ../examples/interactions/SkX_NN_0.jl
julia --project=../../TBModel run_RPA.jl --input ../Inputs/07.09-0.2024_SkX.yml --run_bare false
julia --project=../../TBModel ../examples/models/SkX_2.jl
julia --project=../../TBModel ../examples/interactions/SkX_NN_2.jl
